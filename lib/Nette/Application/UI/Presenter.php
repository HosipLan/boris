...
abstract class NPresenter extends NControl implements IPresenter
{
	...
	final public function injectPrimary(NDIContainer $context, NApplication $application, NHttpContext $httpContext, IHttpRequest $httpRequest, IHttpResponse $httpResponse, NSession $session, NUser $user)
	{

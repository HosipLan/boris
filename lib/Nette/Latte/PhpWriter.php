...
class NPhpWriter extends NObject
{
	...
	public function escape($s)
	{
		...
		case NLatteCompiler::CONTENT_HTML:
			...
			switch ($context[0]) {
			case NLatteCompiler::CONTEXT_SINGLE_QUOTED_ATTR:
			case NLatteCompiler::CONTEXT_DOUBLE_QUOTED_ATTR:
			case NLatteCompiler::CONTEXT_UNQUOTED_ATTR:
				...
				$quote = $context[0] === NLatteCompiler::CONTEXT_SINGLE_QUOTED_ATTR ? ', ENT_QUOTES' : '';
				$s = "htmlSpecialChars($s$quote)";
				return $context[0] === NLatteCompiler::CONTEXT_UNQUOTED_ATTR ? "'\"' . $s . '\"'" : $s;

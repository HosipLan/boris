...
class NSelectBox extends NFormControl
{
	...
	public function __construct($label = NULL, array $items = NULL, $size = NULL)
	{
		...
		$this->addRule($this->validateSelectBoxValid, NRules::$defaultMessages[self::VALID]);
	}
	...
	public function setPrompt($prompt)
	{
		if ($prompt === TRUE) { // back compatibility
			trigger_error(__METHOD__ . '(TRUE) is deprecated; argument must be string.', E_USER_WARNING);
	 ...
	 * @return bool
	 */
	public static function validateSelectBoxValid(IFormControl $control)
	{
